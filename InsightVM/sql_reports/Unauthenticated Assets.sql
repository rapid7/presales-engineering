...
-- Description: Genereate list of known assets with authenticated_scans column set to YES or NO based on use of authentication
-- Data Model Version: 2.2.0

SELECT dsite.name as site, da.ip_address, da.host_name, dos.description as OS, os.certainty_max, TO_CHAR(fa.scan_started, 'MM-DD-YYYY') AS date, fa.last_scan_id, dos.asset_type, 
...
GROUP BY dsite.name, da.ip_address, da.host_name,dos.description, os.certainty_max, fa.vulnerabilities, fa.malware_kits, fa.exploits, fa.scan_started, fa.last_scan_id, dos.asset_type
